...
<p align="center">
<img src="images/06_profiles_03.png"><br>
...
Описание кнопок панели меню приведено в табли.1.
...
«Доступ к форме пользователя» позволяет пользователю использовать соответствующую форму. «Видимость формы в дереве форм для пользователя» добавляет ее в главное меню Программы (рис.9).
...
Доступ может быть предоставлен как к отдельной форме, так и ко всей группе. В последнем случае нужно выставить флаг (![](images/buttons/flagon.png)) рядом с названием соответствующей группы форм (рис.11).
...
<tr>
    ...
    <td>При деактивации настроек типовой формы после сохранения изменений ее отображение в списке форм сменится на пунктирное (рис.15). Отключенные настройки, таким образом, можно определить по внешнему виду</td>
</tr>
<tr>
...
<p align="center">
<img src="images/06_profiles_18.png"><br>
...
После сохранения изменений меню Программы будет выглядеть так (рис.20):
...
<p align="center">
<img src="images/06_profiles_22.png"><br>
...
<p align="center"><i>Таблица 7. Свойства документа (группа «Режим»)</i></p>
...
Описание свойств настройки внешнего вида кнопки приведено в табл. 15.
...
<p align="center">
<img src="images/06_profiles_34.png"><br>
...
<p align="center"><i>Таблица 16. Настройка изображения по умолчанию (группа «Дизайн»)</i></p>
...
<i>Рисунок 35. Пример кнопок разных размеров</i>
</p>
...
<p align="center">
<img src="images/06_profiles_37.png"><br>
...
<p align="center"><i>Таблица 19. «Пресет, загружаемый при нажатии кнопки» (группа «Настройка фрагментов»)</i></p>
...
Для добавления типовой формы на боковую панель нужно нажать «Добавить документ» в разделе «Добавление форм и настроек» (![](images/buttons/green_plus.png)) или в контекстном меню (рис.39).
...
<p align="center"><i>Таблица 26. Свойства документа на боковой панели (группа «Режим») </i></p>

В табл.27 приведено описание свойств документа группы Misc.
...
<p align="center"><i>Таблица 27. Свойства документа на боковой панели (группа Misc)</i></p>

<br>

#### 4.4 Вид/тип записи на боковой панели

Для добавления элемента коллекции (вид/тип записи) на боковую панель нужно в разделе «Добавление форм и настроек» (![](images/buttons/green_plus.png)) или в контекстном меню выбрать соответствующий пункт (рис.43).

<p align="center">
<img src="images/06_profiles_45.png"><br>
<i>Рисунок 43. Добавление элемента коллекции на боковую панель</i>
</p>
 
Элементы коллекции имеют одинаковые свойства, отображаемые в правой части вкладки. Группа «Настройка действий» содержит одно свойство, при активации которого выбранный элемент коллекции будет отключен и убран с боковой панели. Описание свойств групп «Режим» и Misc приведено в табл.28 и табл.29. 
...
<p align="center"><i>Таблица 28. Свойства элемента коллекции на боковой панели (группа «Режим»)</i></p>
...
<p align="center"><i>Таблица 29. Свойства элемента коллекции на боковой панели (группа Misc)</i></p>

<br>	

#### 4.5 Добавление группы

Для удобства элементы боковой панели могут быть объединены в группы. Для добавления группы на боковую панель нужно выбрать соответствующий пункт в разделе «Добавление форм и настроек» (![](images/buttons/green_plus.png) или в контекстном меню (рис.44).

<p align="center">
<img src="images/06_profiles_46.png"><br>
<i>Рисунок 44. Добавление группы для объединения элементов боковой панели</i>
</p>

<p align="center">
<img src="images/06_profiles_47.png"><br>
<i>Рисунок 45. Элементы боковой панели в группе</i>
</p>

Для добавления типовой формы на боковую панель нужно нажать «Добавить документ» в разделе «Добавление форм и настроек» (![](images/buttons/green_plus.png) или в контекстном меню (рис.46).

<p align="center">
<img src="images/06_profiles_48.png"><br>
<i>Рисунок 46. Добавление группы элементов на боковую панель</i>
</p>
...
Как и элементы, описанные выше, группы имеют свойства (рис.47).

<p align="center">
<img src="images/06_profiles_49.png"><br>
<i>Рисунок 47. Свойства группы</i>
</p>

### 5. Дополнительные настройки

Вкладка содержит дополнительные настройки профиля пользователя (рис.48):

<p align="center">
<img src="images/06_profiles_50.png"><br>
<i>Рисунок 48. Вкладка «Дополнительные настройки»</i>
</p>
...
<p align="center"><i>Таблица 30. Дополнительные свойства панели быстрого запуска</i></p>
