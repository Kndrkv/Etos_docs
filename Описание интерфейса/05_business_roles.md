...
Для перехода к настройке уровней доступа из формы создания БР нужно нажать кнопку «Открыть форму настроек уровней доступа» <img src="images/05_business_13.png"> (рис.12).
